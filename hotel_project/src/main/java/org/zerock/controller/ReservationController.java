...
public class ReservationController {
	...
	public String kakaPay() {
		...
		try {
			...
			String parameters="cid=TC0ONETIME&partner_order_id=partner_order_id&partner_user_id=partner_user_id&item_name=초코파이&quantity=1&total_amount=2200&vat_amount=200&tax_free_amount=0&approval_url=https://localhost:8080/hotel/kakaoPay.cls&fail_url=https://localhost:8080/fail&cancel_url=https://localhost:8080/cancel";
