								...
								<form class="requires-validation" novalidate>
									...
									<div class="col-md-12 hp_wrap">
										<input class="form-control hp_input" type="text"
											name="memberPhoneNo" value="${member.memberPhoneNo }">
									...
									<div class="form-button mt-3 join_button_wrap">
										<input type="submit" class="btn btn-dark join_button w-100" value="수정하기" id="update_Button">
									</div>
								</form>
							</div>
						</div>
